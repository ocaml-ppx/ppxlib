...
let rec copy_longident : Ast_506.Longident.t -> Ast_505.Longident.t = function
  | Ast_506.Longident.Lident x0 -> Ast_505.Longident.Lident x0
  | Ast_506.Longident.Ldot (x0, x1) ->
      Ast_505.Longident.Ldot
        (copy_loc copy_longident x0, copy_loc (fun x -> x) x1)
  | Ast_506.Longident.Lapply (x0, x1) ->
      Ast_505.Longident.Lapply
        (copy_loc copy_longident x0, copy_loc copy_longident x1)

and copy_asttypes_constant :
    Ast_506.Asttypes.constant -> Ast_505.Asttypes.constant = function
  | Ast_506.Asttypes.Const_int x0 -> Ast_505.Asttypes.Const_int x0
  | Ast_506.Asttypes.Const_char x0 -> Ast_505.Asttypes.Const_char x0
  | Ast_506.Asttypes.Const_string (x0, x1, x2) ->
      Ast_505.Asttypes.Const_string
        (x0, copy_location x1, Option.map (fun x -> x) x2)
  | Ast_506.Asttypes.Const_float x0 -> Ast_505.Asttypes.Const_float x0
  | Ast_506.Asttypes.Const_int32 x0 -> Ast_505.Asttypes.Const_int32 x0
  | Ast_506.Asttypes.Const_int64 x0 -> Ast_505.Asttypes.Const_int64 x0
  | Ast_506.Asttypes.Const_nativeint x0 -> Ast_505.Asttypes.Const_nativeint x0

and copy_rec_flag : Ast_506.Asttypes.rec_flag -> Ast_505.Asttypes.rec_flag =
  function
  | Ast_506.Asttypes.Nonrecursive -> Ast_505.Asttypes.Nonrecursive
  | Ast_506.Asttypes.Recursive -> Ast_505.Asttypes.Recursive

and copy_direction_flag :
    Ast_506.Asttypes.direction_flag -> Ast_505.Asttypes.direction_flag =
  function
  | Ast_506.Asttypes.Upto -> Ast_505.Asttypes.Upto
  | Ast_506.Asttypes.Downto -> Ast_505.Asttypes.Downto

and copy_private_flag :
    Ast_506.Asttypes.private_flag -> Ast_505.Asttypes.private_flag = function
  | Ast_506.Asttypes.Private -> Ast_505.Asttypes.Private
  | Ast_506.Asttypes.Public -> Ast_505.Asttypes.Public

and copy_mutable_flag :
    Ast_506.Asttypes.mutable_flag -> Ast_505.Asttypes.mutable_flag = function
  | Ast_506.Asttypes.Immutable -> Ast_505.Asttypes.Immutable
  | Ast_506.Asttypes.Mutable -> Ast_505.Asttypes.Mutable

and copy_virtual_flag :
    Ast_506.Asttypes.virtual_flag -> Ast_505.Asttypes.virtual_flag = function
  | Ast_506.Asttypes.Virtual -> Ast_505.Asttypes.Virtual
  | Ast_506.Asttypes.Concrete -> Ast_505.Asttypes.Concrete

and copy_override_flag :
    Ast_506.Asttypes.override_flag -> Ast_505.Asttypes.override_flag = function
  | Ast_506.Asttypes.Override -> Ast_505.Asttypes.Override
  | Ast_506.Asttypes.Fresh -> Ast_505.Asttypes.Fresh

and copy_closed_flag :
    Ast_506.Asttypes.closed_flag -> Ast_505.Asttypes.closed_flag = function
  | Ast_506.Asttypes.Closed -> Ast_505.Asttypes.Closed
  | Ast_506.Asttypes.Open -> Ast_505.Asttypes.Open

and copy_label : Ast_506.Asttypes.label -> Ast_505.Asttypes.label = fun x -> x

and copy_arg_label : Ast_506.Asttypes.arg_label -> Ast_505.Asttypes.arg_label =
  function
  | Ast_506.Asttypes.Nolabel -> Ast_505.Asttypes.Nolabel
  | Ast_506.Asttypes.Labelled x0 -> Ast_505.Asttypes.Labelled x0
  | Ast_506.Asttypes.Optional x0 -> Ast_505.Asttypes.Optional x0

and copy_loc :
    'f0 'g0.
    ('f0 -> 'g0) -> 'f0 Ast_506.Asttypes.loc -> 'g0 Ast_505.Asttypes.loc =
 fun f0 { Ast_506.Asttypes.txt; Ast_506.Asttypes.loc } ->
  { Ast_505.Asttypes.txt = f0 txt; Ast_505.Asttypes.loc = copy_location loc }

and copy_variance : Ast_506.Asttypes.variance -> Ast_505.Asttypes.variance =
  function
  | Ast_506.Asttypes.Covariant -> Ast_505.Asttypes.Covariant
  | Ast_506.Asttypes.Contravariant -> Ast_505.Asttypes.Contravariant
  | Ast_506.Asttypes.NoVariance -> Ast_505.Asttypes.NoVariance
  | Ast_506.Asttypes.Bivariant -> Ast_505.Asttypes.Bivariant

and copy_injectivity :
    Ast_506.Asttypes.injectivity -> Ast_505.Asttypes.injectivity = function
  | Ast_506.Asttypes.Injective -> Ast_505.Asttypes.Injective
  | Ast_506.Asttypes.NoInjectivity -> Ast_505.Asttypes.NoInjectivity

and copy_constant : Ast_506.Parsetree.constant -> Ast_505.Parsetree.constant =
 fun { Ast_506.Parsetree.pconst_desc; Ast_506.Parsetree.pconst_loc } ->
  {
...
and copy_constant_desc :
    Ast_506.Parsetree.constant_desc -> Ast_505.Parsetree.constant_desc =
  function
  | Ast_506.Parsetree.Pconst_integer (x0, x1) ->
      Ast_505.Parsetree.Pconst_integer (x0, Option.map (fun x -> x) x1)
  | Ast_506.Parsetree.Pconst_char x0 -> Ast_505.Parsetree.Pconst_char x0
  | Ast_506.Parsetree.Pconst_string (x0, x1, x2) ->
      Ast_505.Parsetree.Pconst_string
        (x0, copy_location x1, Option.map (fun x -> x) x2)
  | Ast_506.Parsetree.Pconst_float (x0, x1) ->
      Ast_505.Parsetree.Pconst_float (x0, Option.map (fun x -> x) x1)

and copy_location_stack :
    Ast_506.Parsetree.location_stack -> Ast_505.Parsetree.location_stack =
 fun x -> List.map copy_location x

and copy_attribute : Ast_506.Parsetree.attribute -> Ast_505.Parsetree.attribute
    =
 fun {
       Ast_506.Parsetree.attr_name;
       Ast_506.Parsetree.attr_payload;
       Ast_506.Parsetree.attr_loc;
     } ->
  {
...
and copy_extension : Ast_506.Parsetree.extension -> Ast_505.Parsetree.extension
    =
 fun x ->
  let x0, x1 = x in
...
and copy_attributes :
    Ast_506.Parsetree.attributes -> Ast_505.Parsetree.attributes =
 fun x -> List.map copy_attribute x

and copy_payload : Ast_506.Parsetree.payload -> Ast_505.Parsetree.payload =
  function
  | Ast_506.Parsetree.PStr x0 -> Ast_505.Parsetree.PStr (copy_structure x0)
  | Ast_506.Parsetree.PSig x0 -> Ast_505.Parsetree.PSig (copy_signature x0)
  | Ast_506.Parsetree.PTyp x0 -> Ast_505.Parsetree.PTyp (copy_core_type x0)
  | Ast_506.Parsetree.PPat (x0, x1) ->
      Ast_505.Parsetree.PPat (copy_pattern x0, Option.map copy_expression x1)

and copy_core_type : Ast_506.Parsetree.core_type -> Ast_505.Parsetree.core_type
    =
 fun {
       Ast_506.Parsetree.ptyp_desc;
       Ast_506.Parsetree.ptyp_loc;
       Ast_506.Parsetree.ptyp_loc_stack;
       Ast_506.Parsetree.ptyp_attributes;
     } ->
  {
...
and copy_core_type_desc :
    Ast_506.Parsetree.core_type_desc -> Ast_505.Parsetree.core_type_desc =
  function
  | Ast_506.Parsetree.Ptyp_any -> Ast_505.Parsetree.Ptyp_any
  | Ast_506.Parsetree.Ptyp_var x0 -> Ast_505.Parsetree.Ptyp_var x0
  | Ast_506.Parsetree.Ptyp_arrow (x0, x1, x2) ->
      Ast_505.Parsetree.Ptyp_arrow
        (copy_arg_label x0, copy_core_type x1, copy_core_type x2)
  | Ast_506.Parsetree.Ptyp_tuple x0 ->
...
and copy_package_type :
    Ast_506.Parsetree.package_type -> Ast_505.Parsetree.package_type =
 fun {
       Ast_506.Parsetree.ppt_path;
       Ast_506.Parsetree.ppt_constraints;
       Ast_506.Parsetree.ppt_loc;
       Ast_506.Parsetree.ppt_attrs;
     } ->
  {
...
and copy_row_field : Ast_506.Parsetree.row_field -> Ast_505.Parsetree.row_field
    =
 fun {
       Ast_506.Parsetree.prf_desc;
       Ast_506.Parsetree.prf_loc;
       Ast_506.Parsetree.prf_attributes;
     } ->
  {
...
and copy_row_field_desc :
    Ast_506.Parsetree.row_field_desc -> Ast_505.Parsetree.row_field_desc =
  function
  | Ast_506.Parsetree.Rtag (x0, x1, x2) ->
      Ast_505.Parsetree.Rtag
        (copy_loc copy_label x0, x1, List.map copy_core_type x2)
  | Ast_506.Parsetree.Rinherit x0 ->
      Ast_505.Parsetree.Rinherit (copy_core_type x0)

and copy_object_field :
    Ast_506.Parsetree.object_field -> Ast_505.Parsetree.object_field =
 fun {
       Ast_506.Parsetree.pof_desc;
       Ast_506.Parsetree.pof_loc;
       Ast_506.Parsetree.pof_attributes;
     } ->
  {
...
and copy_object_field_desc :
    Ast_506.Parsetree.object_field_desc -> Ast_505.Parsetree.object_field_desc =
  function
  | Ast_506.Parsetree.Otag (x0, x1) ->
      Ast_505.Parsetree.Otag (copy_loc copy_label x0, copy_core_type x1)
  | Ast_506.Parsetree.Oinherit x0 ->
      Ast_505.Parsetree.Oinherit (copy_core_type x0)

and copy_pattern : Ast_506.Parsetree.pattern -> Ast_505.Parsetree.pattern =
 fun {
       Ast_506.Parsetree.ppat_desc;
       Ast_506.Parsetree.ppat_loc;
       Ast_506.Parsetree.ppat_loc_stack;
       Ast_506.Parsetree.ppat_attributes;
     } ->
  {
...
and copy_pattern_desc :
    Ast_506.Parsetree.pattern_desc -> Ast_505.Parsetree.pattern_desc = function
  | Ast_506.Parsetree.Ppat_any -> Ast_505.Parsetree.Ppat_any
  | Ast_506.Parsetree.Ppat_var x0 ->
      Ast_505.Parsetree.Ppat_var (copy_loc (fun x -> x) x0)
  | Ast_506.Parsetree.Ppat_alias (x0, x1) ->
      Ast_505.Parsetree.Ppat_alias (copy_pattern x0, copy_loc (fun x -> x) x1)
  | Ast_506.Parsetree.Ppat_constant x0 ->
      Ast_505.Parsetree.Ppat_constant (copy_constant x0)
  | Ast_506.Parsetree.Ppat_interval (x0, x1) ->
      Ast_505.Parsetree.Ppat_interval (copy_constant x0, copy_constant x1)
  | Ast_506.Parsetree.Ppat_tuple (x0, x1) ->
      Ast_505.Parsetree.Ppat_tuple
        ( List.map
            ...
            x0,
          copy_closed_flag x1 )
  | Ast_506.Parsetree.Ppat_construct (x0, x1) ->
      Ast_505.Parsetree.Ppat_construct
        ( copy_loc copy_longident x0,
          Option.map
            ...
            x1 )
  | Ast_506.Parsetree.Ppat_variant (x0, x1) ->
      Ast_505.Parsetree.Ppat_variant (copy_label x0, Option.map copy_pattern x1)
  | Ast_506.Parsetree.Ppat_record (x0, x1) ->
...
and copy_case : Ast_506.Parsetree.case -> Ast_505.Parsetree.case =
 fun {
       Ast_506.Parsetree.pc_lhs;
       Ast_506.Parsetree.pc_guard;
       Ast_506.Parsetree.pc_rhs;
     } ->
  {
...
and copy_letop : Ast_506.Parsetree.letop -> Ast_505.Parsetree.letop =
 fun { Ast_506.Parsetree.let_; Ast_506.Parsetree.ands; Ast_506.Parsetree.body } ->
  {
...
and copy_binding_op :
    Ast_506.Parsetree.binding_op -> Ast_505.Parsetree.binding_op =
 fun {
       Ast_506.Parsetree.pbop_op;
       Ast_506.Parsetree.pbop_pat;
       Ast_506.Parsetree.pbop_exp;
       Ast_506.Parsetree.pbop_loc;
     } ->
  {
...
and copy_function_param_desc :
    Ast_506.Parsetree.function_param_desc ->
    Ast_505.Parsetree.function_param_desc = function
  | Ast_506.Parsetree.Pparam_val (x0, x1, x2) ->
      Ast_505.Parsetree.Pparam_val
        (copy_arg_label x0, Option.map copy_expression x1, copy_pattern x2)
  | Ast_506.Parsetree.Pparam_newtype x0 ->
      Ast_505.Parsetree.Pparam_newtype (copy_loc (fun x -> x) x0)

and copy_function_param :
    Ast_506.Parsetree.function_param -> Ast_505.Parsetree.function_param =
 fun { Ast_506.Parsetree.pparam_loc; Ast_506.Parsetree.pparam_desc } ->
  {
...
and copy_function_body :
    Ast_506.Parsetree.function_body -> Ast_505.Parsetree.function_body =
  function
  | Ast_506.Parsetree.Pfunction_body x0 ->
      Ast_505.Parsetree.Pfunction_body (copy_expression x0)
  | Ast_506.Parsetree.Pfunction_cases (x0, x1, x2) ->
      Ast_505.Parsetree.Pfunction_cases
        (List.map copy_case x0, copy_location x1, copy_attributes x2)

and copy_type_constraint :
    Ast_506.Parsetree.type_constraint -> Ast_505.Parsetree.type_constraint =
  function
  | Ast_506.Parsetree.Pconstraint x0 ->
      Ast_505.Parsetree.Pconstraint (copy_core_type x0)
  | Ast_506.Parsetree.Pcoerce (x0, x1) ->
      Ast_505.Parsetree.Pcoerce (Option.map copy_core_type x0, copy_core_type x1)

and copy_value_description :
    Ast_506.Parsetree.value_description -> Ast_505.Parsetree.value_description =
 fun {
...
and copy_type_declaration :
    Ast_506.Parsetree.type_declaration -> Ast_505.Parsetree.type_declaration =
 fun {
       Ast_506.Parsetree.ptype_name;
       Ast_506.Parsetree.ptype_params;
       Ast_506.Parsetree.ptype_constraints;
       Ast_506.Parsetree.ptype_kind;
       Ast_506.Parsetree.ptype_private;
       Ast_506.Parsetree.ptype_manifest;
       Ast_506.Parsetree.ptype_attributes;
       Ast_506.Parsetree.ptype_loc;
     } ->
  {
...
and copy_type_kind : Ast_506.Parsetree.type_kind -> Ast_505.Parsetree.type_kind
    = function
  | Ast_506.Parsetree.Ptype_abstract -> Ast_505.Parsetree.Ptype_abstract
  | Ast_506.Parsetree.Ptype_variant x0 ->
      Ast_505.Parsetree.Ptype_variant (List.map copy_constructor_declaration x0)
  | Ast_506.Parsetree.Ptype_record x0 ->
      Ast_505.Parsetree.Ptype_record (List.map copy_label_declaration x0)
  | Ast_506.Parsetree.Ptype_open -> Ast_505.Parsetree.Ptype_open
  | Ast_506.Parsetree.Ptype_external x0 -> Ast_505.Parsetree.Ptype_external x0

and copy_label_declaration :
    Ast_506.Parsetree.label_declaration -> Ast_505.Parsetree.label_declaration =
 fun {
       Ast_506.Parsetree.pld_name;
       Ast_506.Parsetree.pld_mutable;
       Ast_506.Parsetree.pld_type;
       Ast_506.Parsetree.pld_loc;
       Ast_506.Parsetree.pld_attributes;
     } ->
  {
...
and copy_constructor_declaration :
 ...
 fun {
       Ast_506.Parsetree.pcd_name;
       Ast_506.Parsetree.pcd_vars;
       Ast_506.Parsetree.pcd_args;
       Ast_506.Parsetree.pcd_res;
       Ast_506.Parsetree.pcd_loc;
       Ast_506.Parsetree.pcd_attributes;
     } ->
  {
...
and copy_constructor_arguments :
    Ast_506.Parsetree.constructor_arguments ->
    Ast_505.Parsetree.constructor_arguments = function
  | Ast_506.Parsetree.Pcstr_tuple x0 ->
      Ast_505.Parsetree.Pcstr_tuple (List.map copy_core_type x0)
  | Ast_506.Parsetree.Pcstr_record x0 ->
      Ast_505.Parsetree.Pcstr_record (List.map copy_label_declaration x0)

and copy_type_extension :
    Ast_506.Parsetree.type_extension -> Ast_505.Parsetree.type_extension =
 fun {
       Ast_506.Parsetree.ptyext_path;
       Ast_506.Parsetree.ptyext_params;
       Ast_506.Parsetree.ptyext_constructors;
       Ast_506.Parsetree.ptyext_private;
       Ast_506.Parsetree.ptyext_loc;
       Ast_506.Parsetree.ptyext_attributes;
     } ->
  {
...
and copy_extension_constructor :
 ...
 fun {
       Ast_506.Parsetree.pext_name;
       Ast_506.Parsetree.pext_kind;
       Ast_506.Parsetree.pext_loc;
       Ast_506.Parsetree.pext_attributes;
     } ->
  {
...
and copy_type_exception :
    Ast_506.Parsetree.type_exception -> Ast_505.Parsetree.type_exception =
 fun {
       Ast_506.Parsetree.ptyexn_constructor;
       Ast_506.Parsetree.ptyexn_loc;
       Ast_506.Parsetree.ptyexn_attributes;
     } ->
  {
...
and copy_extension_constructor_kind :
    Ast_506.Parsetree.extension_constructor_kind ->
    Ast_505.Parsetree.extension_constructor_kind = function
  | Ast_506.Parsetree.Pext_decl (x0, x1, x2) ->
      Ast_505.Parsetree.Pext_decl
        ( List.map (copy_loc (fun x -> x)) x0,
          copy_constructor_arguments x1,
          Option.map copy_core_type x2 )
  | Ast_506.Parsetree.Pext_rebind x0 ->
      Ast_505.Parsetree.Pext_rebind (copy_loc copy_longident x0)

and copy_class_type :
    Ast_506.Parsetree.class_type -> Ast_505.Parsetree.class_type =
 fun {
       Ast_506.Parsetree.pcty_desc;
       Ast_506.Parsetree.pcty_loc;
       Ast_506.Parsetree.pcty_attributes;
     } ->
  {
...
and copy_class_type_desc :
    Ast_506.Parsetree.class_type_desc -> Ast_505.Parsetree.class_type_desc =
  function
  | Ast_506.Parsetree.Pcty_constr (x0, x1) ->
      Ast_505.Parsetree.Pcty_constr
        (copy_loc copy_longident x0, List.map copy_core_type x1)
  | Ast_506.Parsetree.Pcty_signature x0 ->
      Ast_505.Parsetree.Pcty_signature (copy_class_signature x0)
  | Ast_506.Parsetree.Pcty_arrow (x0, x1, x2) ->
      Ast_505.Parsetree.Pcty_arrow
        (copy_arg_label x0, copy_core_type x1, copy_class_type x2)
  | Ast_506.Parsetree.Pcty_extension x0 ->
      Ast_505.Parsetree.Pcty_extension (copy_extension x0)
  | Ast_506.Parsetree.Pcty_open (x0, x1) ->
      Ast_505.Parsetree.Pcty_open (copy_open_description x0, copy_class_type x1)

and copy_class_signature :
    Ast_506.Parsetree.class_signature -> Ast_505.Parsetree.class_signature =
 fun { Ast_506.Parsetree.pcsig_self; Ast_506.Parsetree.pcsig_fields } ->
  {
...
and copy_class_type_field :
    Ast_506.Parsetree.class_type_field -> Ast_505.Parsetree.class_type_field =
 fun {
       Ast_506.Parsetree.pctf_desc;
       Ast_506.Parsetree.pctf_loc;
       Ast_506.Parsetree.pctf_attributes;
     } ->
  {
...
and copy_class_type_field_desc :
    Ast_506.Parsetree.class_type_field_desc ->
    Ast_505.Parsetree.class_type_field_desc = function
  | Ast_506.Parsetree.Pctf_inherit x0 ->
      Ast_505.Parsetree.Pctf_inherit (copy_class_type x0)
  | Ast_506.Parsetree.Pctf_val x0 ->
      Ast_505.Parsetree.Pctf_val
        (let x0, x1, x2, x3 = x0 in
         ( copy_loc copy_label x0,
           ...
           copy_core_type x3 ))
  | Ast_506.Parsetree.Pctf_method x0 ->
      Ast_505.Parsetree.Pctf_method
        (let x0, x1, x2, x3 = x0 in
         ( copy_loc copy_label x0,
           ...
           copy_virtual_flag x2,
           copy_core_type x3 ))
  | Ast_506.Parsetree.Pctf_constraint x0 ->
      Ast_505.Parsetree.Pctf_constraint
        (let x0, x1 = x0 in
         (copy_core_type x0, copy_core_type x1))
  | Ast_506.Parsetree.Pctf_attribute x0 ->
      Ast_505.Parsetree.Pctf_attribute (copy_attribute x0)
  | Ast_506.Parsetree.Pctf_extension x0 ->
      Ast_505.Parsetree.Pctf_extension (copy_extension x0)

and copy_class_infos :
    'f0 'g0.
    ('f0 -> 'g0) ->
    'f0 Ast_506.Parsetree.class_infos ->
    'g0 Ast_505.Parsetree.class_infos =
 fun f0
     {
       Ast_506.Parsetree.pci_virt;
       Ast_506.Parsetree.pci_params;
       Ast_506.Parsetree.pci_name;
       Ast_506.Parsetree.pci_expr;
       Ast_506.Parsetree.pci_loc;
       Ast_506.Parsetree.pci_attributes;
     } ->
  {
...
and copy_class_description :
    Ast_506.Parsetree.class_description -> Ast_505.Parsetree.class_description =
...
and copy_class_expr :
    Ast_506.Parsetree.class_expr -> Ast_505.Parsetree.class_expr =
 fun {
       Ast_506.Parsetree.pcl_desc;
       Ast_506.Parsetree.pcl_loc;
       Ast_506.Parsetree.pcl_attributes;
     } ->
  {
...
and copy_class_expr_desc :
    Ast_506.Parsetree.class_expr_desc -> Ast_505.Parsetree.class_expr_desc =
  function
  | Ast_506.Parsetree.Pcl_constr (x0, x1) ->
      Ast_505.Parsetree.Pcl_constr
        (copy_loc copy_longident x0, List.map copy_core_type x1)
  | Ast_506.Parsetree.Pcl_structure x0 ->
      Ast_505.Parsetree.Pcl_structure (copy_class_structure x0)
  | Ast_506.Parsetree.Pcl_fun (x0, x1, x2, x3) ->
      Ast_505.Parsetree.Pcl_fun
        ( copy_arg_label x0,
          Option.map copy_expression x1,
          copy_pattern x2,
          copy_class_expr x3 )
  | Ast_506.Parsetree.Pcl_apply (x0, x1) ->
...
and copy_class_field :
    Ast_506.Parsetree.class_field -> Ast_505.Parsetree.class_field =
 fun {
       Ast_506.Parsetree.pcf_desc;
       Ast_506.Parsetree.pcf_loc;
       Ast_506.Parsetree.pcf_attributes;
     } ->
  {
...
and copy_module_type_desc :
    Ast_506.Parsetree.module_type_desc -> Ast_505.Parsetree.module_type_desc =
  function
  | Ast_506.Parsetree.Pmty_ident x0 ->
      Ast_505.Parsetree.Pmty_ident (copy_loc copy_longident x0)
  | Ast_506.Parsetree.Pmty_signature x0 ->
      Ast_505.Parsetree.Pmty_signature (copy_signature x0)
  | Ast_506.Parsetree.Pmty_functor (x0, x1) ->
      Ast_505.Parsetree.Pmty_functor
        (copy_functor_parameter x0, copy_module_type x1)
  | Ast_506.Parsetree.Pmty_with (x0, x1) ->
      Ast_505.Parsetree.Pmty_with
        (copy_module_type x0, List.map copy_with_constraint x1)
  | Ast_506.Parsetree.Pmty_typeof x0 ->
      Ast_505.Parsetree.Pmty_typeof (copy_module_expr x0)
  | Ast_506.Parsetree.Pmty_extension x0 ->
      Ast_505.Parsetree.Pmty_extension (copy_extension x0)
  | Ast_506.Parsetree.Pmty_alias x0 ->
      Ast_505.Parsetree.Pmty_alias (copy_loc copy_longident x0)

and copy_functor_parameter :
    Ast_506.Parsetree.functor_parameter -> Ast_505.Parsetree.functor_parameter =
  function
  | Ast_506.Parsetree.Unit -> Ast_505.Parsetree.Unit
  | Ast_506.Parsetree.Named (x0, x1) ->
      Ast_505.Parsetree.Named
        (copy_loc (Option.map (fun x -> x)) x0, copy_module_type x1)

and copy_signature : Ast_506.Parsetree.signature -> Ast_505.Parsetree.signature
    =
 fun x -> List.map copy_signature_item x

and copy_signature_item :
    Ast_506.Parsetree.signature_item -> Ast_505.Parsetree.signature_item =
 fun { Ast_506.Parsetree.psig_desc; Ast_506.Parsetree.psig_loc } ->
  {
...
and copy_signature_item_desc :
    Ast_506.Parsetree.signature_item_desc ->
...
and copy_module_substitution :
 ...
 fun {
       Ast_506.Parsetree.pms_name;
       Ast_506.Parsetree.pms_manifest;
       Ast_506.Parsetree.pms_attributes;
       Ast_506.Parsetree.pms_loc;
     } ->
  {
...
and copy_module_type_declaration :
 ...
 fun {
       Ast_506.Parsetree.pmtd_name;
       Ast_506.Parsetree.pmtd_type;
       Ast_506.Parsetree.pmtd_attributes;
       Ast_506.Parsetree.pmtd_loc;
     } ->
  {
...
and copy_open_infos :
    'f0 'g0.
    ('f0 -> 'g0) ->
    'f0 Ast_506.Parsetree.open_infos ->
    'g0 Ast_505.Parsetree.open_infos =
 fun f0
     {
       Ast_506.Parsetree.popen_expr;
       Ast_506.Parsetree.popen_override;
       Ast_506.Parsetree.popen_loc;
       Ast_506.Parsetree.popen_attributes;
     } ->
  {
...
and copy_open_description :
    Ast_506.Parsetree.open_description -> Ast_505.Parsetree.open_description =
 fun x -> copy_open_infos (copy_loc copy_longident) x

and copy_open_declaration :
    Ast_506.Parsetree.open_declaration -> Ast_505.Parsetree.open_declaration =
 fun x -> copy_open_infos copy_module_expr x

and copy_include_infos :
    'f0 'g0.
    ('f0 -> 'g0) ->
    'f0 Ast_506.Parsetree.include_infos ->
    'g0 Ast_505.Parsetree.include_infos =
 fun f0
     {
       Ast_506.Parsetree.pincl_mod;
       Ast_506.Parsetree.pincl_loc;
       Ast_506.Parsetree.pincl_attributes;
     } ->
  {
...
and copy_with_constraint :
    Ast_506.Parsetree.with_constraint -> Ast_505.Parsetree.with_constraint =
  function
  | Ast_506.Parsetree.Pwith_type (x0, x1) ->
      Ast_505.Parsetree.Pwith_type
        (copy_loc copy_longident x0, copy_type_declaration x1)
  | Ast_506.Parsetree.Pwith_module (x0, x1) ->
      Ast_505.Parsetree.Pwith_module
        (copy_loc copy_longident x0, copy_loc copy_longident x1)
  | Ast_506.Parsetree.Pwith_modtype (x0, x1) ->
      Ast_505.Parsetree.Pwith_modtype
        (copy_loc copy_longident x0, copy_module_type x1)
  | Ast_506.Parsetree.Pwith_modtypesubst (x0, x1) ->
      Ast_505.Parsetree.Pwith_modtypesubst
        (copy_loc copy_longident x0, copy_module_type x1)
  | Ast_506.Parsetree.Pwith_typesubst (x0, x1) ->
      Ast_505.Parsetree.Pwith_typesubst
        (copy_loc copy_longident x0, copy_type_declaration x1)
  | Ast_506.Parsetree.Pwith_modsubst (x0, x1) ->
      Ast_505.Parsetree.Pwith_modsubst
        (copy_loc copy_longident x0, copy_loc copy_longident x1)

and copy_module_expr :
    Ast_506.Parsetree.module_expr -> Ast_505.Parsetree.module_expr =
 fun {
       Ast_506.Parsetree.pmod_desc;
       Ast_506.Parsetree.pmod_loc;
...
and copy_structure_item :
    Ast_506.Parsetree.structure_item -> Ast_505.Parsetree.structure_item =
 fun { Ast_506.Parsetree.pstr_desc; Ast_506.Parsetree.pstr_loc } ->
  {
...
and copy_structure_item_desc :
    Ast_506.Parsetree.structure_item_desc ->
    Ast_505.Parsetree.structure_item_desc = function
  | Ast_506.Parsetree.Pstr_eval (x0, x1) ->
...
and copy_value_constraint :
  ...
  | Ast_506.Parsetree.Pvc_coercion { ground; coercion } ->
...
and copy_value_binding :
    Ast_506.Parsetree.value_binding -> Ast_505.Parsetree.value_binding =
 fun {
       Ast_506.Parsetree.pvb_pat;
       Ast_506.Parsetree.pvb_expr;
       Ast_506.Parsetree.pvb_constraint;
       Ast_506.Parsetree.pvb_attributes;
       Ast_506.Parsetree.pvb_loc;
     } ->
  {
...
and copy_module_binding :
    Ast_506.Parsetree.module_binding -> Ast_505.Parsetree.module_binding =
 fun {
       Ast_506.Parsetree.pmb_name;
       Ast_506.Parsetree.pmb_expr;
       Ast_506.Parsetree.pmb_attributes;
       Ast_506.Parsetree.pmb_loc;
     } ->
  {
...
and copy_toplevel_phrase :
    Ast_506.Parsetree.toplevel_phrase -> Ast_505.Parsetree.toplevel_phrase =
  function
  | Ast_506.Parsetree.Ptop_def x0 ->
      Ast_505.Parsetree.Ptop_def (copy_structure x0)
  | Ast_506.Parsetree.Ptop_dir x0 ->
      Ast_505.Parsetree.Ptop_dir (copy_toplevel_directive x0)

and copy_toplevel_directive :
    Ast_506.Parsetree.toplevel_directive -> Ast_505.Parsetree.toplevel_directive
    =
 fun {
       Ast_506.Parsetree.pdir_name;
       Ast_506.Parsetree.pdir_arg;
       Ast_506.Parsetree.pdir_loc;
     } ->
  {
...
and copy_directive_argument :
    Ast_506.Parsetree.directive_argument -> Ast_505.Parsetree.directive_argument
    =
 fun { Ast_506.Parsetree.pdira_desc; Ast_506.Parsetree.pdira_loc } ->
  {
...
and copy_directive_argument_desc :
    Ast_506.Parsetree.directive_argument_desc ->
    Ast_505.Parsetree.directive_argument_desc = function
  | Ast_506.Parsetree.Pdir_string x0 -> Ast_505.Parsetree.Pdir_string x0
  | Ast_506.Parsetree.Pdir_int (x0, x1) ->
      Ast_505.Parsetree.Pdir_int (x0, Option.map (fun x -> x) x1)
  | Ast_506.Parsetree.Pdir_ident x0 ->
      Ast_505.Parsetree.Pdir_ident (copy_longident x0)
  | Ast_506.Parsetree.Pdir_bool x0 -> Ast_505.Parsetree.Pdir_bool x0
