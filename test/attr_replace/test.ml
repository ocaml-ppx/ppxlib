...
[@@@expand_inline
  class class_field =
    object val foo = () [@@alert "-1"] [@@test.clf "suffix"] [@@alert "-2"] end
]
class class_field =
...
[@@@expand_inline
  class type class_type_field =
    object val x: int [@@alert "-1"] [@@test.ctf "suffix"] [@@alert "-2"] end
]
class type class_type_field =
...
[@@@expand_inline
  module type S = sig [%%foo] [@@test.sig.ext "suffix"] end
]
...
[@@@expand_inline
  module _ = struct "" [@@test.str.evl "suffix"] end
]
module _ = struct ;;"" end
[@@@end]
