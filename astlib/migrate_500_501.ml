...
let copy_structure : Ast_500.Parsetree.structure -> Ast_501.Parsetree.structure
    =
 fun x -> x

let copy_signature : Ast_500.Parsetree.signature -> Ast_501.Parsetree.signature
    =
 fun x -> x
...
let copy_core_type : Ast_500.Parsetree.core_type -> Ast_501.Parsetree.core_type
    =
 fun x -> x
...
let copy_pattern : Ast_500.Parsetree.pattern -> Ast_501.Parsetree.pattern =
 fun x -> x

let copy_case : Ast_500.Parsetree.case -> Ast_501.Parsetree.case = fun x -> x
